  ...
  return (
    <div className="space-y-6">
      <section className="grid gap-5 lg:grid-cols-[minmax(0,1.3fr)_18rem]">
        ...
        <div className="rounded-[1.75rem] border border-border bg-primary px-6 py-4 text-primary-foreground">
          <p className="text-xs uppercase tracking-[0.24em] text-primary-foreground/70">Flow</p>
          <p className="mt-3 text-sm text-primary-foreground/80">建议流程</p>
